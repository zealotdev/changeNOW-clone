...
const Tabs = () => {
  ...
  return (
    <div className="md:tab-w-lg tab-bg rounded-lg bg-gray-700 mt-10 text-sm font-semibold">
      ...
      <div className="tab-bg tab-content-border py-4 px-6 rounded-lg rounded-t-none">
        {activeTab == 'tab 1' && (
          <div>
            <div className="input-field text-2xl border border-yellow-200 rounded-t-lg text-white flex">
              <div>
                <input
                ...
                />
                <label
                  className="relative -left-56 -top-8 text-gray-500 font-light text-sm"
                  htmlFor="youpay"
                >
                  You Send
                </label>
              ...
              <select
                className="relative -right-7 rounded-tr-lg py-6 px-12 text-2xl text-white w-44"
                name="currency"
                id="currency"
              >
            ...
            <div className="my-4 flex justify-between rounded-lg">
              ...
              <div className="exchange-btn flex h-7 rounded-lg">
                <button>
                  <svg
                    className="stroke-current stroke-2 transform rotate-90  stroke-color__active"
                    width="21"
                    height="10"
                    fill="none"
                ...
                <button>
                  <svg
                    className="stroke-current stroke-2 transform -rotate-90 font-extrabold stroke-color__active"
                    width="21"
                    height="10"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="input-field text-2xl rounded-t-lg text-white flex">
              ...
              <select
                className="relative -right-12 rounded-tr-lg py-6 px-12 text-2xl text-white w-44"
                name="currency"
                id="currency"
              >
                <option value="BTC">BTC</option>
            ...
            <button className="bg-green-500 w-full mt-10 mb-4 py-3 rounded-lg text-white font-bold text-lg">
              Exchange
            </button>
          </div>
        )}
        {activeTab == 'tab 2' && (
          <div>
            <div className="input-field text-2xl border border-yellow-200 rounded-t-lg text-white flex">
              ...
              <select
                className="relative -right-10 rounded-tr-lg py-6 px-12 text-2xl text-white w-44"
                name="currency"
                id="currency"
              >
